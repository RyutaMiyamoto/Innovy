...
class NewsListTableViewModel {
    ...
    private func createCellViewModel(articles: [Article] = []) {
        ...
        newsListCellViewModel = NewsListTableViewModel.createNewsListCellViewModel(articles: newsList)
    }
    ...
    func loadNext() {
        ...
        let nextViewModelList = NewsListTableViewModel.createNewsListCellNextViewModel(articles: newsList, viewModelList: viewModelList, page: page)
        page += 1
